...
\begin{enumerate}
	...
	\item implemented Eternal Connect in a singleton class. It's an evolution of the Eternal Discovery that I previously created for Pigeon Messenger (\seqsplit{https://github.com/deib-polimi/PigeonMessanger}). Eternal Connect is able to discovery and connect automatically to nearby devices.
